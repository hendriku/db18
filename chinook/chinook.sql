...
-- Aufgabe 4
SELECT e.EMPLOYEEID, e.FIRSTNAME, e.LASTNAME, subE.EMPLOYEEID AS "SUBID"
FROM EMPLOYEE e JOIN EMPLOYEE subE ON e.EMPLOYEEID = subE.REPORTSTO OR e.EMPLOYEEID = subE.EMPLOYEEID
ORDER BY EMPLOYEEID
;
